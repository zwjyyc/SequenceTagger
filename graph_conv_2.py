...
class GraphConvCRFV2:
	...
	if args.conv != 0:
		...
		residual = True
                if ind == 0:
		    residual = False
		prev_output = layers[-1].forward_all(prev_output, up_ids, up_id_masks, bv_ur_slicess[ind], b_ur_slicess[ind], down_ids, down_id_masks, bv_dr_slicess[ind], b_dr_slicess[ind], residual = residual)
		prev_output = apply_dropout(prev_output, dropout)
